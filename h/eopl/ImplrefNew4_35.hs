...
exs = [
  ...
  "let swap = proc(x,y) let temp = x in { set x = y; set y = temp} in let a = 33 in let b = 44 in {(swap ref a ref b); -(a, b)}",
  "let swap = proc(x,y) let temp = x in { set x = y; set y = temp} in let a = 33 in let b = 44 in {(swap ref a b); -(a, b)}"
  ]
