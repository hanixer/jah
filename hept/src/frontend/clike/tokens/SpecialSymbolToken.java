...
public class SpecialSymbolToken extends Token {
    ...
    public void readSingleDoubleAssign(ClikeTokenType doubleOp, ClikeTokenType assignOp, ClikeTokenType singleOp)
	    throws Exception {
	char ch = currentChar();
	nextChar();
	if (currentChar() == ch) {
    ...
    public void readAngleBracket(ClikeTokenType doubleOp, ClikeTokenType doubleAssign, ClikeTokenType singleOp,
	    ClikeTokenType singleAsign) throws Exception {
	char ch = currentChar();
	nextChar();
	if (currentChar() == ch) {
	    if (nextChar() == '=') {
    ...
    private void readSingleAssign(ClikeTokenType starAssign, ClikeTokenType star) throws Exception {
	if (nextChar() == '=') {
    ...
    private void makeTokenAndAdvance(ClikeTokenType tokType) throws Exception {
	type = tokType;
	nextChar();
    }
}
